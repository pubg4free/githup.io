...
// MEMERIKSA EMAIL YANG SUDAH LOGIN. JIKA EMAIL YANG DIGUNAKAN SAMA DENGAN YANG SEBELUMNYA, MAKA DIALIHKAN KE HALAMAN PROSES MENUNGGU HADIAH
$file_lines = file('system/checkLogin.txt');
foreach ($file_lines as $file => $value) {
$data = explode("|", $value);
if (in_array($email, $data)) {
echo "<form id='arpantek_processing' method='POST' action='processing.php'>
